...
/**
 * Submenu for BookOrbit Sync settings: the BookOrbit server URL, a dedicated login, the
 * document match method, and a per-feature enable toggle (progress, sessions, highlights,
 * bookmarks). Fully self-contained against BookOrbitConfig so it survives upstream pulls.
 */
